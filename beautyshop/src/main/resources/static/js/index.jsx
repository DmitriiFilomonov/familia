...
async function includeCardMaster () {
...
let response = await fetch("http://localhost:2345/workers", requestOptions)
let data = await response.json();

console.log(data);
	
    //var xui = fetch('http://localhost:2345/workers').then(response => {return response.json()})//.then(data => console.log(data))
    //var json = JSON.parse(xui)
	checkClick++
	let name = data.name;
